...
STEP_ARTIFACT_KEYS: dict[str, ArtifactKey] = {
    "physical_world": "world_physical",
    "simulate_world": "world",
    "world_builder_v2": "bible",
    "reconcile_world": "reconciliation",
    "art_direction_v2": "style_bible",
    "story_v2": "story",
    "graph_v2": "narrative_project",
    "media_intents_v2": "media_intents",
    "image_media_v2": "images",
    "local_maps_v2": "local_maps",
    "music_media_v2": "midi",
    "accept_media_v2": "media",
    "gm_index_v2": "gm_index",
    "package_v2": "package_candidate",
    "accept_package_v2": "package_acceptance",
    "packager": "packager",
}
