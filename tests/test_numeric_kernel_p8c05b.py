    ...
    assert true_divisions == {
        ...
        "src/worldgen/conformance/generator.py:64",
            ...
            "src/worldgen/conformance/source_coverage.py:100",
                "src/worldgen/conformance/hardening.py:122",
                "src/worldgen/determinism_diff.py:198",
        ...
        "src/worldgen/simulation/replay.py:167",
                            "src/worldgen/simulation/scheduler.py:213",
                            "src/worldgen/simulation/scheduler.py:218",
                            "src/worldgen/simulation/scheduler.py:390",
                            "src/worldgen/simulation/scheduler.py:394",
                            "src/worldgen/simulation/scheduler.py:395",
                            "src/worldgen/simulation/scheduler.py:396",
                            "src/worldgen/simulation/scheduler.py:399",
                            "src/worldgen/simulation/scheduler.py:400",
                            "src/worldgen/simulation/scheduler.py:404",
                                            "src/worldgen/simulation/scheduler.py:2147",
