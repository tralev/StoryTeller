...
> **Archived 2026-08-12.** This historical Phase 5.6 plan is non-normative and
> contains stale paths, counts, and completion states. Use `roadmap.md` for all
> current work and `worldgen-coverage.generated.md` for worldgen obligations.
...
> **Superseded for v2 publication:** the frozen product contract requires 100%
> image and MIDI coverage. The threshold design below is retained only as
> historical Phase 5.6 rationale and must not configure production v2 output.
