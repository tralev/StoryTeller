...
| `WG-HIST-004` | Collect proposals from immutable start-of-tick state, sort by frozen conflict key, resolve conflicts once | `worldgen.simulation.proposals.resolve_proposals, worldgen.simulation.scheduler` | `proposal_resolutions, history_events` | `proposal-validator` | `tests/worldgen/simulation/test_proposals.py::test_conflict_resolution_is_order_independent_and_exactly_once` | P8.C05F | partial |
...
*96 requirements across 7 domains. Source hash: cf38b3ae5dd1*
