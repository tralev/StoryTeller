...
| `WG-HIST-004` | Collect proposals from immutable start-of-tick state, sort by frozen conflict key, resolve conflicts once | `worldgen.simulation.proposals.resolve_proposals, worldgen.simulation.scheduler` | `proposal_resolutions, history_events` | `proposal-validator` | `tests/worldgen/simulation/test_proposals.py::test_ageing_and_relationships_share_one_annual_social_snapshot` | P8.C05F | partial |
...
*96 requirements across 7 domains. Source hash: ae18144483b0*
