...
| 5 | `art_direction_v2` | `style_bible` | `world`, `bible` | text | abort | yes |
| 6 | `story_v2` | `story` | `world`, `bible`, `local_maps` | text | abort | yes |
| 7 | `graph_v2` | `narrative_project` | `world`, `bible`, `story` | text | abort | yes |
| 8 | `media_intents_v2` | `media_intents` | `narrative_project` | text | abort | yes |
| 9 | `reconcile_world` | `reconciliation` | `world`, `bible`, `story`, `narrative_project`, `media_intents` | validator | abort | yes |
